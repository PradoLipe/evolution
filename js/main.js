    ...
    // EVOLUTION V5.62: cada uma acende no instante em que o casco passa por ela.
    ...
    (function footerVoyage() {
        ...
        let elapsed = 0, lastTs = 0, sailing = false, played = false;
        ...
        // ultimas letras entregues — a versao "V5.62" ficava acesa ate a varredura
        ...
        window.EvoFooterVoyage = { play: () => play(0) };

        // Rede de seguranca: se por algum caminho de restauracao de sessao o
        // showMainApp nao disparar a viagem, ela comeca sozinha assim que o
        // rodape ficar visivel.
        (function autoStart(tries) {
            if (played) return;
            const el = document.getElementById('footerBrand');
            if (el && el.offsetParent) { play(0); return; }
